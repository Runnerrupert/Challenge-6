...
class Cli {
  // Variables for vehicles created, the selected vin and a boolean for exiting the program
    ...
    inquirer
      ...
      .then((answers) => {
        ...
        if (answers.action === 'Print details') {
          ...
          // find the selected vehicle and make sure it is a truck, if it is tow the vehicle, otherwise console log an error
          for (let i = 0; i < this.vehicles.length; i++) {
            if (this.vehicles[i].vin === this.selectedVehicleVin) {
          ...
          // find the selected vehicle and make sure it is a motorbike, if it is do a wheelie with the selected motorbike, otherwise console log an error
          for (let i = 0; i < this.vehicles.length; i++) {
            if (this.vehicles[i].vin === this.selectedVehicleVin) {
